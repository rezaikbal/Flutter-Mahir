...
@GenerateMocks([NowPlayingUsecase, PopularMovieUsecase, TopRatedMovieUsecase])
void main() {
  ...
  setUp(() {
    ...
    provider = MovieListNotifier(
      nowPlayingUsecase: mockGetNowPlayingMovies,
      popularMovieUsecase: mockGetPopularMovies,
      topRatedMovieUsecase: mockGetTopRatedMovies,
    )..addListener(() {
        listenerCallCount += 1;
      });
  });
  ...
  group('top rated movies', () {
    ...
    test('should change movies data when data is gotten successfully',
      ...
      ///assert
      expect(provider.topRatedMoviesState, RequestState.Success);
  ...
  group('popular movies', () {
    ...
    test('should change movies data when data is gotten successfully',
      ...
      ///assert
      expect(provider.popularMoviesState, RequestState.Success);
