...
void main(){
  ...
  group('get Now Playing Movies', () {
    final tMovieList = MovieResponse.fromJson(json.decode(readJson('dummy_data/now_playing.json'))).listMovie;
  ...
  group('search movies', () {
    final tSearchResult = MovieResponse.fromJson(json.decode(readJson('dummy_data/search_spiderman_movie.json'))).listMovie;
  ...
  group('search tv', () {
    final tSearchResult = TvResponse.fromJson(json.decode(readJson('dummy_data/tv_search.json'))).listTv;
    final tQuery = 'Spiderman';
  ...
  group('get movie recommendations', () {
    final tMovieList = MovieResponse.fromJson(json.decode(readJson('dummy_data/movie_recommendations.json'))).listMovie;
    final tId = 1;
  ...
  group('Get Top Rated Tv Series', () {
    final tvList = TvResponse.fromJson(json.decode(readJson('dummy_data/tv_top_rated.json'))).listTv;
  ...
  group('Get Popular Tv Series', () {
    final tvList = TvResponse.fromJson(json.decode(readJson('dummy_data/tv_popular.json'))).listTv;
  ...
  group('Get Airing Today Tv Series', () {
    final tvList = TvResponse.fromJson(json.decode(readJson('dummy_data/tv_airing_today.json'))).listTv;
  ...
  group('Get On The Air Tv Series', () {
    final tvList = TvResponse.fromJson(json.decode(readJson('dummy_data/tv_on_the_air.json'))).listTv;
